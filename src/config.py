...
CAP_TOOLBENCH = 20000         # Multi-call rich examples (~48% multi-call)
CAP_DOLLY_NO_CALL = 8000      # No-call instruction following examples
CAP_WIKITEXT_NO_CALL = 8000   # No-call language understanding examples
CAP_SYNTHETIC_PARALLEL = 7000  # Synthetic parallel tool call examples
